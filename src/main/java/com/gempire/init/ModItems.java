...
public class ModItems {
    ...
    public static final RegistryObject<Item> WHITE_QUARTZ_GEM = ITEMS.register("quartz_gem_0", () ->
    ...
    public static final RegistryObject<Item> ORANGE_QUARTZ_GEM = ITEMS.register("quartz_gem_1", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> MAGENTA_QUARTZ_GEM = ITEMS.register("quartz_gem_2", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIGHT_BLUE_QUARTZ_GEM = ITEMS.register("quartz_gem_3", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> YELLOW_QUARTZ_GEM = ITEMS.register("quartz_gem_4", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIME_QUARTZ_GEM = ITEMS.register("quartz_gem_5", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> PINK_QUARTZ_GEM = ITEMS.register("quartz_gem_6", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> GRAY_QUARTZ_GEM = ITEMS.register("quartz_gem_7", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIGHT_GRAY_QUARTZ_GEM = ITEMS.register("quartz_gem_8", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> CYAN_QUARTZ_GEM = ITEMS.register("quartz_gem_9", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> PURPLE_QUARTZ_GEM = ITEMS.register("quartz_gem_10", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BLUE_QUARTZ_GEM = ITEMS.register("quartz_gem_11", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BROWN_QUARTZ_GEM = ITEMS.register("quartz_gem_12", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> GREEN_QUARTZ_GEM = ITEMS.register("quartz_gem_13", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> RED_QUARTZ_GEM = ITEMS.register("quartz_gem_14", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BLACK_QUARTZ_GEM = ITEMS.register("quartz_gem_15", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    ...
    public static final RegistryObject<Item> GREEN_JASPER_GEM = ITEMS.register("jasper_gem_13", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> RED_JASPER_GEM = ITEMS.register("jasper_gem_14", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    ...
    public static final RegistryObject<Item> WHITE_AGATE_GEM = ITEMS.register("agate_gem_0", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> ORANGE_AGATE_GEM = ITEMS.register("agate_gem_1", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> MAGENTA_AGATE_GEM = ITEMS.register("agate_gem_2", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIGHT_BLUE_AGATE_GEM = ITEMS.register("agate_gem_3", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> YELLOW_AGATE_GEM = ITEMS.register("agate_gem_4", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIME_AGATE_GEM = ITEMS.register("agate_gem_5", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> PINK_AGATE_GEM = ITEMS.register("agate_gem_6", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> GRAY_AGATE_GEM = ITEMS.register("agate_gem_7", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> LIGHT_GRAY_AGATE_GEM = ITEMS.register("agate_gem_8", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> CYAN_AGATE_GEM = ITEMS.register("agate_gem_9", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> PURPLE_AGATE_GEM = ITEMS.register("agate_gem_10", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BLUE_AGATE_GEM = ITEMS.register("agate_gem_11", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BROWN_AGATE_GEM = ITEMS.register("agate_gem_12", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> GREEN_AGATE_GEM = ITEMS.register("agate_gem_13", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> RED_AGATE_GEM = ITEMS.register("agate_gem_14", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BLACK_AGATE_GEM = ITEMS.register("agate_gem_15", () ->
            new Item(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    ...
    public static final RegistryObject<Item> YELLOW_TOPAZ_GEM = ITEMS.register("topaz_gem_4", () ->
            new ItemGem(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> BLUE_TOPAZ_GEM = ITEMS.register("topaz_gem_6", () ->
            new ItemGem(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> PINK_TOPAZ_GEM = ITEMS.register("topaz_gem_11", () ->
            new ItemGem(new Item.Properties().group(ModItemGroup.GEMSTONES).maxStackSize(1).isImmuneToFire()));
}
