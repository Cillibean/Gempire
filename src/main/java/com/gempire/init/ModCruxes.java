...
public class ModCruxes {
    ...
    public static GemConditions QUARTZ_CONDITIONS(){
        ...
        gemCruxes.add(new Crux(Blocks.BUDDING_AMETHYST.defaultBlockState(), 14, CruxType.MINERAL, gemTemperatureMin, gemTemperatureMax));
    ...
    public static GemConditions RUTILE_CONDITIONS(){
        ...
        gemCruxes.add(new Crux(Blocks.DRIPSTONE_BLOCK.defaultBlockState(), 16, CruxType.INORGANIC, gemTemperatureMin, gemTemperatureMax));
