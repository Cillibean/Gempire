...
public class YellowAltarTE extends BlockEntity implements GeoBlockEntity {

    protected static final RawAnimation SPIN = RawAnimation.begin().thenLoop("spin");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public YellowAltarTE(BlockPos pos, BlockState state) {
        super(ModTE.YELLOW_ALTAR_TE.get(), pos, state);
    }
    ...
    protected <E extends YellowAltarTE> PlayState spinAnimController(final AnimationState<E> state) {
