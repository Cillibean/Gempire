...
public class WhiteAltarTE extends BlockEntity implements GeoBlockEntity {

    protected static final RawAnimation SPIN = RawAnimation.begin().thenLoop("spin");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public WhiteAltarTE(BlockPos pos, BlockState state) {
        super(ModTE.WHITE_ALTAR_TE.get(), pos, state);
    }
    ...
    protected <E extends WhiteAltarTE> PlayState spinAnimController(final AnimationState<E> state) {
