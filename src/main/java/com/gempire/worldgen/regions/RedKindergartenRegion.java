...
public class RedKindergartenRegion extends Region {

    public RedKindergartenRegion(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.RED_KINDERGARTEN));
