...
public class DungeonStructures extends Structure {
    ...
    public DungeonStructures(Structure.StructureSettings config,
    ...
    public StructureType<?> type() {
        return ModStructures.DUNGEON_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
