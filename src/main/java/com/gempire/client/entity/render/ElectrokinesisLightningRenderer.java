...
import org.joml.Matrix4f;
    ...
    @OnlyIn(Dist.CLIENT)
    public class ElectrokinesisLightningRenderer extends EntityRenderer<ElectrokinesisLightning> {
        public ElectrokinesisLightningRenderer(EntityRendererProvider.Context p_174286_) {
            super(p_174286_);
        }
        ...
        public ResourceLocation getTextureLocation(ElectrokinesisLightning p_115264_) {
