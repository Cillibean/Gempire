...
@OnlyIn(Dist.CLIENT)
public class HuntressLightningRenderer extends EntityRenderer<HuntressLightning> {
    public HuntressLightningRenderer(EntityRendererProvider.Context p_174286_) {
        super(p_174286_);
    }
    ...
    public ResourceLocation getTextureLocation(HuntressLightning p_115264_) {
