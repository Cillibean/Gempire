...
@OnlyIn(Dist.CLIENT)
public class WhiteAttackRenderer extends EntityRenderer<WhiteAttackEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Gempire.MODID, "textures/entity/projectiles/white_base/base.png");
    private static final RenderType RENDER_TYPE = RenderType.entityTranslucent(TEXTURE_LOCATION);

    public WhiteAttackRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    protected int getBlockLightLevel(WhiteAttackEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(WhiteAttackEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public ResourceLocation getTextureLocation(WhiteAttackEntity p_114078_) {
