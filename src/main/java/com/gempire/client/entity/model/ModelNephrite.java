...
public class ModelNephrite<T extends EntityGem> extends ModelGem<T> {
    ...
    public ModelNephrite() {
       ...
       // this.HairL.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.Ponytail_1.setTextureOffset(5, 0).addBox(-3.5F, -12.0F, 2.5F, 7.0F, 7.0F, 7.0F, 0.0F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Head, this.LegL, this.LShoulder, this.ArmL, this.ArmR, this.Skirt, this.RShoulder, this.Body, this.LegR).forEach((modelRenderer) -> {
