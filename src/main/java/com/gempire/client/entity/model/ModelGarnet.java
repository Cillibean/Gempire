...
public class ModelGarnet<T extends EntityGem> extends ModelGem<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("gempire", "custom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ArmPuffRight = ArmRight.addOrReplaceChild("ArmPuffRight", CubeListBuilder.create().texOffs(113, 13).addBox(-2.6F, 6.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition LegPuffLeft = LegLeft.addOrReplaceChild("LegPuffLeft", CubeListBuilder.create().texOffs(88, 20).addBox(-2.7F, -3.2F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
