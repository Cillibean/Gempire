...
public class FusionUIContainer extends AbstractContainerMenu {
    ...
    public FusionUIContainer(int windowID, Inventory playerInventory, EntityFusion gem) {
        ...
        for(int k = 0; k < 4; ++k) {
            ...
            this.addSlot(new Slot(gem, 27 + k, 27 + k*18, 75){
                ...
                public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
                    return Pair.of(InventoryMenu.BLOCK_ATLAS, FusionUIContainer.ARMOR_SLOT_TEXTURES[equipmentslottype.getIndex()]);
                }
    ...
    public FusionUIContainer(int windowID, Inventory playerInventory, FriendlyByteBuf extraData){
        this(windowID, playerInventory, FusionUIContainer.getGem(playerInventory, extraData));
    }

    public static EntityFusion getGem(Inventory playerInventory, FriendlyByteBuf extraData){
        ...
        if(entity instanceof EntityFusion){
            return (EntityFusion) entity;
        }
