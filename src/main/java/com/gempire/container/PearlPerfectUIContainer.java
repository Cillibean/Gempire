...
public class PearlPerfectUIContainer extends AbstractContainerMenu {
    public final ContainerLevelAccess canInteract;

    public final EntityPearl gem;

    public PearlPerfectUIContainer(int windowID, Inventory playerInventory, EntityPearl gem) {
    ...
    public PearlPerfectUIContainer(int windowID, Inventory playerInventory, FriendlyByteBuf extraData){
        this(windowID, playerInventory, PearlPerfectUIContainer.getGem(playerInventory, extraData));
    }
