...
public class EntityAILumberjack extends Goal {
    public EntityGem follower;
    public BlockPos target;
    public BlockPos startPos;
    public double speed;
    public ChunkPos chunk;
    public EntityAILumberjack(EntityGem entityIn, double speedIn) {
    ...
    public boolean canUse() {
        return this.follower.getMovementType() == 0 && follower.getLumberjack();
    }

    @Override
    public boolean canContinueToUse() {
        return this.follower.getMovementType() == 0 && this.follower.getLumberjack();
    }
    ...
    public void stop() {
        ...
        this.follower.setLumberjack(false);
        this.follower.setPathfindingMalus(BlockPathTypes.WATER, 0);
    }
