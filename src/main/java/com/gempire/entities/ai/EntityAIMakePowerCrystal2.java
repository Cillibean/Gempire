    ...
    public void start(){
        ...
        if(this.follower.distanceToSqr(target.getX(), target.getY(), target.getZ()) < 4){
            if(this.follower.level.getBlockState(this.target).getBlock() == Blocks.REDSTONE_BLOCK){
                if(this.follower.level.getBlockState(this.target.north()).getBlock() == ModBlocks.PRISMATIC_BLOCK.get()){
                    if(this.follower.level.getBlockState(this.target.south()).getBlock() == ModBlocks.PRISMATIC_BLOCK.get()){
                        if(this.follower.level.getBlockState(this.target.west()).getBlock() == ModBlocks.PRISMATIC_BLOCK.get()){
                            if(this.follower.level.getBlockState(this.target.east()).getBlock() == ModBlocks.PRISMATIC_BLOCK.get()){
