        ...
        for (int x = 0; x < 3; x++){
            for (int z = 0; z < 3; z++){
                for (int y = 0; y < 3; y++){
                    ...
                    if(this.holder.level().getBlockState(pos).getBlock() == Blocks.AIR && this.holder.level().getBlockState(pos.below()).getBlock() != Blocks.AIR && this.holder.level().getBlockState(pos.below()).getBlock() != Blocks.FIRE) {
