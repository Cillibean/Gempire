...
public class EntityGildedHuntress extends Monster implements GeoAnimatable {
    ...
    public EntityGildedHuntress(EntityType<? extends EntityGildedHuntress> p_33002_, Level p_33003_) {
