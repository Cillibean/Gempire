...
public class EntityWhiteMonster extends Monster implements GeoAnimatable {
    ...
    public EntityWhiteMonster(EntityType<? extends EntityWhiteMonster> p_33002_, Level p_33003_) {
